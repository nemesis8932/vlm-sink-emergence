...
\item {\bf Declaration of LLM usage}
    ...
    \item[] Answer: \answerNA{}
    \item[] Justification: Language models appear in this work as the object of study, a 135M-parameter decoder trained and probed by the authors. No large language model forms part of the method. LLM coding assistants were used to write and refactor the training, probe and analysis code and to edit prose, which Appendix~A discloses; the experimental design, measurements, analysis decisions and claims are the authors' own, so this use does not affect the methodology, rigor or originality of the research.
    \item[] Guidelines:
    \begin{itemize}
