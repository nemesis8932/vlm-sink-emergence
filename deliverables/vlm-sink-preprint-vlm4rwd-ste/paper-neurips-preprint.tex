...
\textit{Compute.} All training and probing ran on a single NVIDIA RTX 4090 with 48 GB of memory. The four-condition comparison and the 1B-token RF run together used approximately 48 hours of GPU time.
...
Figures 4 to 6 support Sections 4.1 and 4.3. Figure 4 locates concentration by layer and query head, Figure 5 shows the per-group associations summarized in Table 3, and Figure 6 records the attention entropy over the same runs, which falls in the two conditions with strong concentration and does not in the others.
