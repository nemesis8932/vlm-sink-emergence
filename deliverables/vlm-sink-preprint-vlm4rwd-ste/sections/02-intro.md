...
signatures (§2). Whether the signatures arrive together, in sequence, or independently takes a
...
levers each target one sink-relevant mechanism (§3): standard softmax attention (*baseline*), a
